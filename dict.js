//Copyrigths -> http://sanskritdocuments.org/dict/dictall.txt
module.exports = [
  ...
  { aMbaa: 'mother' },
  { 'a.nsha': 'part, angle' },
  { 'a.nshabhuutaM': 'has been a part of her' },
  ...
  { atra: 'here' },
  { atha: 'thereupon' },
  { athashabda: 'the word atha (prayers are started with words atha or AUM)' },
  { 'atha.rH': 'object, meaning' },
  { atharvaNvaakyaM: 'atharvaNa1 word-piece' },
  ...
  { anabhiGYa: 'ignorant of, unacquainted with' },
  { anayoH: 'of them' },
  ...
  { anusvaaraH: 'the accompanying sound or letter.' },
  ...
  { anvichchha: 'try for' },
  { anvita: '(p.p) Followed or attended by, in company with, joined by; having ossessed of; overpowerd by, connected grammatically;' },
  { anvitaaH: 'absorbed' },
  ...
  { abhraM: 'cloud' },
  { 'ama.nda': 'not slow or dull, active, intelligent; sharp, strong, violent, not little' },
  { amanyata: 'believed' },
  { amarshha: '(m) anger' },
  ...
  { ashhTottariidashaa: 'A lunar based Dasha system uses 108 yr cycle and one chooses it according to certain criteria' },
  { ashhTau: 'eight' },
  ...
  { aakarNadhanuraasana: 'the shooting bow posture' },
  { aakarshha: 'attracted' },
  ...
  { aashita: '(a) Eaten, given to eat; satisfied by eating' },
  { aashitaM: 'eating' },
  ...
  { uurdhva: 'raised' },
  { uurdhvaM: 'upwards' },
  { uurdhvaprasaaritaekapaadaasana: 'balancing forward posture' },
  { uurdhvamukha: 'face upwards' },
  { uurdhvaretaH: 'a celibate intending to control(upward) the semen' },
  { uurdhvahastattanaasana: 'the up-stretched arms posture' },
  ...
  { karmabhaava: 'The 10th house of Careers and Work' },
  ...
  { kalpadruma: 'kalpa-vRiksha : the tree that will give you anything you can' },
  ...
  { kaa: 'who' },
  { kaapurushha: 'contemptible fellow' },
  { kaaM: 'which' },
  ...
  { kishora: 'son' },
  { kishorii: 'daughter' },
  { kisalaya: 'A sprout, a young and tender shoot or foliage' },
  { 'kiidR^ishii': 'how' },
  { 'kiirt.h': 'to tell' },
  ...
  { kiirtiH: 'fame' },
  { kiirtii: 'fame' },
  { kupariikShaka: 'one who cannot judge value correctly' },
  ...
  { 'kR^ishhNapaksha': 'Dark half of lunar month, also known as vadyapaksha' },
  ...
  { saMpaadaka: 'editor' },
  { saMpaadakiiya: 'editorial' },
  { saMpaadanaM: 'editing, accomplishing, effecting, fulfilment, gaining, obtaining, acquiring, cleaning, clearing' },
  { sat: 'existence.' },
  { sattva: 'essence, main quality or essence of being.' },
  { samanvita: '(p.p) Connected with, connected in natural order; followed; Endowed with; affected by; collected together (sam.h + anu+ root i).' },
  { samUhaH: 'group, collection, multitude, assemblage, aggregate, number, flock, troop' },
  { samuuhanaM: 'bringing together, collection, plenty' },
  { sayata: 'attempting' },
  { 'saMmuuDhabhaavin.h': 'adj. deluded' },
  { saM: 'prefix for well' },
  { 'saM+tR^i': 'to cross' },
